...
public class Campeonato {
    ...
    Equipa formarEquipaMaravilha(Campeonato liga) {
        ...
        equipaMaravilha.adicionarJogadorEquipaMaravilha(todosGuardaRedes.get(0), this);
    ...
    private void ordenarAvancados(ArrayList<Jogador> jogador) {
        ...
        while (continuar) {
            ...
            for (int i = 0; i < jogador.size()-1; i++) {
                ...
                if (jogAnterior.getNumGolosMarcados() < jogPosterior.getNumGolosMarcados()) {
                    temp = jogAnterior;
    ...
    private void ordenarGuardaRedes(ArrayList<Jogador> jogador) {
        ...
        while (continuar) {
            int contador = 0;
            for (int i = 0; i < jogador.size()-1; i++) {
                if (((GuardaRedes) jogador.get(i)).getNumGolosSofridos() > ((GuardaRedes) jogador.get(i + 1)).getNumGolosSofridos()) {
                    temp = jogador.get(i);
